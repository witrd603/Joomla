...
class CommentPhotoAccess extends Restriction implements BooleanRestriction
{
    protected $restrictionName = 'comment_photo_access';
    protected $restrictionMessage = 'membership_restriction_error_comment_photo_access';
