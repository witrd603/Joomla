...
class ChatFactoryAccess extends Restriction implements BooleanRestriction
{
    protected $restrictionName = 'chat_factory_access';
    protected $restrictionMessage = 'membership_restriction_error_chat_factory_access';
