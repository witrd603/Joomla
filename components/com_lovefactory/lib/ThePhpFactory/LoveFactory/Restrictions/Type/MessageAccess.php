...
class MessageAccess extends Restriction implements BooleanRestriction
{
    protected $restrictionName = 'message_access';
    protected $restrictionMessage = 'membership_restriction_error_message_access';
