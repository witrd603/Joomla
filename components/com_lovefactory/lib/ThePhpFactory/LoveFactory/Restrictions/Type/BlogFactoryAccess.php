...
class BlogFactoryAccess extends Restriction implements BooleanRestriction
{
    protected $restrictionName = 'blog_factory_access';
    protected $restrictionMessage = 'membership_restriction_error_blog_factory_access';
