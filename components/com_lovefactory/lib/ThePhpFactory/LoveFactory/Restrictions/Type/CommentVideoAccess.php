...
class CommentVideoAccess extends Restriction implements BooleanRestriction
{
    protected $restrictionName = 'comment_video_access';
    protected $restrictionMessage = 'membership_restriction_error_comment_video_access';
