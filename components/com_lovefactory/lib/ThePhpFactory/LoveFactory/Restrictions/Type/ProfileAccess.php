...
class ProfileAccess extends Restriction implements BooleanRestriction
{
    protected $restrictionName = 'profile_access';
    protected $restrictionMessage = 'membership_restriction_error_access_profile';
